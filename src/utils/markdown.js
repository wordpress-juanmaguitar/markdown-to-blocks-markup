...
const { Parser: commonmarkParser, Renderer: commonmarkRenderer } = commonmark;
...
const htmlToMarkdown = (html) => {
  ...
  node
    ...
    .forEach((fontNode) => (fontNode.innerHTML = `**${fontNode.innerHTML}**`));
  ...
  node
    ...
    .forEach((codeNode) => (codeNode.innerHTML = `\`${codeNode.innerHTML}\``));
  ...
  node.querySelectorAll("br").forEach((brNode) => (brNode.outerHTML = "\n"));
...
WpBlocksRenderer.prototype = Object.create(commonmarkRenderer.prototype);
